...
object Instructions {
  ...
  def SEAL               = BitPat("b?????????????????000?????1010111")  // new instruction SEAL
  def UNSEAL             = BitPat("b?????????????????000?????1110111")  // new instruction UNSEAL
  ...
  def CMOV               = BitPat("b1000000??????????000?????0110011")  // new instruction CMOV
  ...
  def CMOVW              = BitPat("b1000000??????????000?????0111011")  // new instruction: CMOVW
